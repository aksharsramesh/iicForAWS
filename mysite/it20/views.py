...
def signup(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            email.send()
            return HttpResponse('Please confirm your email address by clicking on the link sent to your email ID.(Please check for the email in all categories - UPDATES, SPAM, PROMOTION)')
    else:
        form = SignupForm()
